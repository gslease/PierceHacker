...
### e. Inverse Trig Functions
Now that we know how to enter ![equation](https://latex.codecogs.com/png.latex?%5Csin%5E2%7B%28x%29%7D), let's take a look at how to enter an inverse trig function like arc tangent, cosine inverse, etc. In most math classes, we could use expressions such as "![equation](https://latex.codecogs.com/png.latex?%5Carctan%7B%28x%29%7D)" and "![equation](https://latex.codecogs.com/png.latex?%5Ctan%5E%7B-1%7D%7B%28x%29%7D)" interchangeably. However, WAMAP will only accept one of these. Entering "(tan(x))^-1" will not work. Regardless of the trig function in question, the inverse must be entered as the "arc" version (e.g. ![equation](https://latex.codecogs.com/png.latex?%5Carcsin%7B%28x%29%7D), ![equation](https://latex.codecogs.com/png.latex?%5Carccos%7B%28x%29%7D), ![equation](https://latex.codecogs.com/png.latex?%5Carctan%7B%28x%29%7D), etc).
### f. Rounding  
