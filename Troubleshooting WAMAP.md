...
### d. Trig Functions of Degree>1
Some questions may have answers in the forma of a trigonometric function whose degree is greater than 1. For example, an answer may be $\sin^2{(x)}$, or $\tan^3{(x)}$
### e. Inverse Trig Functions
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODMwMzYwMTJdfQ==
-->